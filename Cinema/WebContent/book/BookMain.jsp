...
function imgChange(flag){
 ...
 if(flag == 1){ //마우스 오버일경우
     document.images.jungle.src = "./MovieImage/jungle01.JPG";
 } else if(flag == 2){
     document.images.jungle.src = "./MovieImage/jungle02.JPG";
 }
...
<c:forEach var="bean" items="${requestScope.lists}">
 <td align="center">
 <input type="button" name="detail_btb" onclick="detailViewPopup();" value="상세보기"></button>
 <input type="button" name="book_btn" onclick="bookPopup();" value="예매하기"></button>
 </td>
 </c:forEach>
